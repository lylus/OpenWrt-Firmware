...
wget https://github.com/lylus/OpenWrt-Firmware/raw/main/autoupdate.sh /etc/config/autoupdate.sh && chmod 755 /etc/config/autoupdate.sh && /etc/config/autoupdate.sh
